...
【身體水分參考】成年人身體水分一般佔體重的45%至65%，充足的水分有助維持代謝功能及器官運作。水分率偏低可能與脫水或肌肉量不足有關。本應用程式在體內水分卡片下方展示標準參考供用家自行對照。
【基礎代謝率參考】基礎代謝率是指身體在完全靜止狀態下維持生命所需的最低熱量消耗。肌肉量較高者一般基礎代謝率亦較高。基礎代謝率可用千卡（kcal）或千焦（kJ）表示，1千卡約等於4.184千焦。本應用程式在基礎代謝率卡片下方展示 TANITA 參考值供用家自行對照。
【肌少症指數參考】肌少症指數（SMI，Skeletal Muscle Index）由 TANITA 身體組成分析儀量度，反映骨骼肌質量相對身高的比例，是評估肌少症風險的指標。本應用程式在卡片下方展示標準參考供用家自行對照。
【手握力參考】手握力是長者肌力與整體健康的重要指標，手握力偏弱與活動能力下降相關。可透過握力球、阻力帶等簡單訓練改善。本應用程式在手握力卡片下方展示 職安局 標準參考供用家自行對照。
【坐地前伸測試參考】坐地前伸測試反映膕繩肌與下背柔軟度。規律伸展可改善柔軟度，減少跌倒與腰背痛風險。本應用程式在坐地前伸卡片下方展示 職安局 標準參考供用家自行對照。
