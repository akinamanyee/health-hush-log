...
function Index() {
  ...
  return (
      <main className="relative min-h-screen bg-background">
        ...
        />
        <section className="relative flex min-h-screen w-full flex-col items-center justify-end pb-[14%] sm:pb-[16%] md:pb-[18%]">
          <Button
            type="button"
            onClick={() => void navigate({ to: "/logbook" })}
            size="lg"
            className="h-14 w-[min(72%,18rem)] sm:w-[min(48%,12rem)] rounded-xl px-6 text-lg font-semibold shadow-lg"
          >
            進入
          </Button>
        </section>
