      ...
      <main className="relative min-h-screen bg-background">
        ...
        <section className="relative flex min-h-screen w-full flex-col items-center">
          <Button
            ...
            size="lg"
            className="absolute bottom-[22%] sm:bottom-[17%] md:bottom-[18%] left-1/2 -translate-x-1/2 h-16 sm:h-14 w-[min(90%,23rem)] sm:w-[min(48%,12rem)] rounded-xl px-6 text-lg font-semibold shadow-lg"
          >
            進入
          </Button>
        </section>
